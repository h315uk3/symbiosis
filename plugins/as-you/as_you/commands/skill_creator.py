...
GENERATED_PREFIX = "u-"
"""Prefix for all as-you generated artifacts (skills, agents, commands)."""


def ensure_prefix(name: str) -> str:
    """
    Ensure a name has the as-you generated prefix.

    Args:
        name: Original name (e.g., "api-setup" or "u-api-setup")

    Returns:
        Name with prefix (e.g., "u-api-setup")

    Examples:
        >>> ensure_prefix("api-setup")
        'u-api-setup'
        >>> ensure_prefix("u-api-setup")
        'u-api-setup'
        >>> ensure_prefix("u-")
        'u-'
        >>> ensure_prefix("")
    ...
    if name.startswith(GENERATED_PREFIX):
        return name
    return f"{GENERATED_PREFIX}{name}"
...
def create_skill(
    ...
    """
    Create a Claude Code skill in .claude/skills/.

    The skill directory name is automatically prefixed with 'u-' to identify
    it as generated by the as-you plugin. Frontmatter includes source: as-you.
    ...
    """
    # Ensure u- prefix
    skill_name = ensure_prefix(skill_name)

    # Locate .claude/skills directory
    plugins_dir = Path(".claude/skills")
